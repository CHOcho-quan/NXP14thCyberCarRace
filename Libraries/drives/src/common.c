...
{
#if defined(MK60DN)
    mcgout_clk_mhz = (uint32_t)(EX_REF_CLK * ((uint32_t)(MCG->C6 & MCG_C6_VDIV0_MASK) + 24u) / ((MCG->C5 & MCG_C5_PRDIV0_MASK) + 1u));
#elif defined(MK60FX)
    ...
    bus_clk_mhz = mcgout_clk_mhz / ((uint32_t)((SIM->CLKDIV1 & SIM_CLKDIV1_OUTDIV2_MASK) >> SIM_CLKDIV1_OUTDIV2_SHIFT)+ 1u);
