...
//    Cpu mode     =  thumb
//    Endian       =  little
//    Source file  =  E:\IARworkspace\CamCar_IAR\LPLD\HW\HW_MCG.c
//    Command line =  
//        -f C:\Users\57416\AppData\Local\Temp\EW290A.tmp
//        (E:\IARworkspace\CamCar_IAR\LPLD\HW\HW_MCG.c -lCN
...
//    Locale       =  C
//    List file    =  E:\IARworkspace\CamCar_IAR\FLASH\List\HW_MCG.s
//
///////////////////////////////////////////////////////////////////////////////
...
// E:\IARworkspace\CamCar_IAR\LPLD\HW\HW_MCG.c
//    1 /**
//    2  * @file HW_MCG.c
...
//  139   MCG->C1 = MCG_C1_CLKS(2) | MCG_C1_FRDIV(3);  
        ...
        STRB     R0,[R12, #+0]
//  140   
//  141   while (MCG->S & MCG_S_IREFST_MASK){}; // @@@@@@@@
??LPLD_PLL_Setup_20:
...
//  142   
//  143   while (((MCG->S & MCG_S_CLKST_MASK) >> MCG_S_CLKST_SHIFT) != 0x2){}; // @@@@@@@@@@@@@@@(ext ref clk)
??LPLD_PLL_Setup_21:
        LDR.N    R0,??LPLD_PLL_Setup_19+0x10  ;; 0x40064006
        LDRB     R0,[R0, #+0]
        UXTB     R0,R0            ;; ZeroExt  R0,R0,#+24,#+24
...
//  144   
//  145   // @@FBE@@
//  146   // @@ PLL @@@@@, PLLCLKEN=0, PLLSTEN=0, PRDIV=5
//  147   // @@@@@@@@ PRDIV @. @@@@@@@@@@@@
//  148   // @@ 2MHz @@@@@@ PLL.
//  149   MCG->C5 = MCG_C5_PRDIV(prdiv); // @@ PLL @@@@@@@@@@ 
        ANDS     R7,R7,#0x1F
        LDR.N    R0,??LPLD_PLL_Setup_19+0x14  ;; 0x40064004
        STRB     R7,[R0, #+0]
//  150   
//  151   // @@MCG_C6@@@@@@,@@LOLIE@PLL@@@@@@@,@PLL VCO@@@
//  152   MCG->C6 = 0x0;
        MOVS     R0,#+0
...
//  182  *
//  183  * @@:
//  184  * @@@@@@@@@RAM@@@@@@@@@@@@@@@@@@errata e2448.
//  185  * @Flash@@@@@@@@@@Flash@@@@@@@.
//  186  * @@@Flash@@@@@@@.
//  187  * @@@@@@@@@@@@@@@@@@@@@@@@@@@@.
//  188  *
//  189  * @@:
//  190  *    outdiv1~outdiv4--@@@core, bus, FlexBus, Flash@@@@@@
//  191  */

        SECTION `.textrw`:CODE:NOROOT(2)
        SECTION_TYPE SHT_PROGBITS, SHF_WRITE | SHF_EXECINSTR
        THUMB
//  192 __ramfunc void LPLD_Set_SYS_DIV(uint32 outdiv1, uint32 outdiv2, uint32 outdiv3, uint32 outdiv4)
//  193 {
LPLD_Set_SYS_DIV:
        PUSH     {R4-R6}
//  194   uint32 temp_reg;
//  195   uint8 i;
//  196   
//  197   temp_reg = FMC->PFAPR; // @@ FMC_PFAPR @@@
...
//  210   {}
//  211   
//  212   FMC->PFAPR = temp_reg; // @@@@@ FMC_PFAPR @@@@
