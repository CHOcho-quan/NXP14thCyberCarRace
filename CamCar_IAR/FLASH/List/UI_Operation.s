...
//    Cpu mode     =  thumb
//    Endian       =  little
//    Source file  =  E:\IARworkspace\CamCar_IAR\source\UI_Operation.c
//    Command line =  
//        -f C:\Users\57416\AppData\Local\Temp\EWFF7F.tmp
//        (E:\IARworkspace\CamCar_IAR\source\UI_Operation.c -lCN
...
//    Locale       =  C
//    List file    =  E:\IARworkspace\CamCar_IAR\FLASH\List\UI_Operation.s
//
///////////////////////////////////////////////////////////////////////////////
...
// E:\IARworkspace\CamCar_IAR\source\UI_Operation.c
//    1 /*
...
//  180   if(Key1()==0){
Key1_Read:
        LDR.N    R0,??DataTable4_11  ;; 0x400ff010
        LDR      R0,[R0, #+0]
        UBFX     R0,R0,#+8,#+1
        CMP      R0,#+0
        BNE.N    ??Key1_Read_0
