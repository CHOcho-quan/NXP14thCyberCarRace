///////////////////////////////////////////////////////////////////////////////
//
// IAR ANSI C/C++ Compiler V8.20.1.14183/W32 for ARM      06/Jul/2019  19:41:18
// Copyright 1999-2017 IAR Systems AB.
//
//    Cpu mode     =  thumb
//    Endian       =  little
//    Source file  =  E:\IARworkspace\CamCar_IAR\LPLD\HW\HW_I2C.c
//    Command line =  
//        -f C:\Users\57416\AppData\Local\Temp\EW28F9.tmp
//        (E:\IARworkspace\CamCar_IAR\LPLD\HW\HW_I2C.c -lCN
...
//    Locale       =  C
//    List file    =  E:\IARworkspace\CamCar_IAR\FLASH\List\HW_I2C.s
//
///////////////////////////////////////////////////////////////////////////////
...
// E:\IARworkspace\CamCar_IAR\LPLD\HW\HW_I2C.c
//    1 /*
//    2  * @file HW_I2C.c
...
//   59   if(i2cx == I2C0)
??LPLD_I2C_Init_0:
        LDR.W    R6,??DataTable7_2  ;; 0x40066000
        CMP      R0,R6
        BNE.N    ??LPLD_I2C_Init_1
//   60   {
//   61     SIM->SCGC4 |= SIM_SCGC4_I2C0_MASK; //@@I2C0@@
        LDR.W    R6,??DataTable7_3  ;; 0x40048034
        LDR      R6,[R6, #+0]
        ORRS     R6,R6,#0x40
...
//   78       PORTD->PCR[9] = PORT_PCR_MUX(2) | ode_mask;
        UXTB     R4,R4            ;; ZeroExt  R4,R4,#+24,#+24
        ORRS     R4,R4,#0x200
        LDR.N    R2,??DataTable7_7  ;; 0x4004c024
        STR      R4,[R2, #+0]
//   79     }
...
//   90   { 
//   91     SIM->SCGC4 |= SIM_SCGC4_I2C1_MASK; //@@I2C1@@
//   92 
//   93     if(scl_pin == PTE1)
//   94     {
...
//  116     //@@I2C@@@@@@@
//  117     //1,@@1@@@@@@@IICIF@@@@@@;
//  118     //2,@Calling Address@@@@@@@@@@@@K60@@1456@I2Cx_S@@@IAAS@;
//  119     //3,@@@@@@@@@@@@@@IICIF@@@@@@;
//  120     //  @@@@@1@@II2Cx_S@ARBL@@@@ I2Cx_S@ IICIF@@@@;
//  121     //4,@@SMB@@@@SHTF2 interrupt@@@@SHTF2 timeout@IICIF@@@@@@;
//  122     //  @@@@@1@@I2Cx_SMB@SLTF@@@@ I2Cx_S@ IICIF@@@@;
//  123     //5,@SLT@@@@@0@@SMBus@SCL low timer@@@@SLT@@@IICIF@@@@@@;
//  124     //  @@@@@1@@I2Cx_SMB@SHTF2@@@@ I2Cx_S@ IICIF@@@@;
//  125     //6,@Wakeup @@@I2C@@@@@@@@@Wakeup@@@@@@@@.
//  126 
...
??LPLD_I2C_Init_7:
        ANDS     R1,R1,#0x3F
        STRB     R1,[R0, #+1]
//  143   i2cx->C1 = I2C_C1_IICEN_MASK;      //@@I2Cx
        MOVS     R1,#+128
        STRB     R1,[R0, #+2]
//  144   
//  145   return 1;
...
//  167   {
//  168     SIM->SCGC4 &= ~SIM_SCGC4_I2C0_MASK; //@@I2C0@@
...
//  172   {
//  173     SIM->SCGC4 &= ~SIM_SCGC4_I2C1_MASK; //@@I2C1@@
...
//  301  *      |__I2C1           --I2C@@1
//  302  *    is_wait--@@@@@@@@
//  303  *      |__I2C_ACK_OFF    --@@@@Ack
//  304  *      |__I2C_ACK_ON     --@@@@Ack@@@@ACK@@
//  305  * @@:
//  306  *    @
//  307  */
